...
export const meta = {
  ...
  editUrl: 'pages/docs/git-integrations/vercel-for-github.mdx',
...
/>
<Caption>
  <ProductName /> for GitHub deploying a pull request automatically.
</Caption>
...
/>
<Caption>
  The "You own the Repository" section with a prompt to install <ProductName />{' '}
  for GitHub.
</Caption>
...
/>
<Caption>
  <ProductName /> for GitHub installed and ready to set up a project.
</Caption>
