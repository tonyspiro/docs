...
export const meta = {
  ...
  editUrl: 'pages/docs/git-integrations/vercel-for-bitbucket.mdx',
...
<Caption style={{ marginTop: '-40px' }}>
  Commits pushed to Bitbucket are automatically built and deployed with{' '}
  <ProductShortName />.
</Caption>
...
/>
<Caption>
  <ProductName /> for Bitbucket, ready to connect.
</Caption>
