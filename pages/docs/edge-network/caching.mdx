...
export const meta = {
  ...
  editUrl: 'pages/docs/edge-network/caching.mdx',
...
- Requests that contain a `_vercel_no_cache=1` cookie.
- Requests that contain a `?_vercel_no_cache=1` request parameter.
