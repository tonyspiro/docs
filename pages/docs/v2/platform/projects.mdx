...
export const meta = {
  ...
  lastEdited: '2020-07-24T14:16:01.000Z'
}
...
To bypass the protection programmatically, please read the [Bypassing Password Protection Programmatically](/docs/v2/platform/frequently-asked-questions#bypassing-password-protection-programmatically) section.
