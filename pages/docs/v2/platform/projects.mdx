...
export const meta = {
  ...
  lastEdited: '2020-07-13T16:18:55.000Z'
}
...
This setting is overwritten when a deployment is created using the CLI with the [`--public` option](/docs/cli#commands/overview/unique-options/public) or the [`public` property](/docs/configuration#project/public) in `vercel.json`.
...
<Note>
  Deployments created before `July 8th, 2020 at 7:05 PM (UTC)` have fixed
  configuration and cannot be changed with this setting.
</Note>
