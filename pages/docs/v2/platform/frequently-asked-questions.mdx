...
When [Password Protection](/docs/v2/platform/projects#password-protection) is enabled on your Projects,
...
This steps are required per url and cookie values cannot be shared among Deployments.
