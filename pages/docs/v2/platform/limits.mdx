...
Deployments that contain more files than the limit will fail at the [build step](/docs/v2/build-step/). If you encounter this error and you would like to bypass it, please contact [support@vercel.com](mailto:support@vercel.com).
