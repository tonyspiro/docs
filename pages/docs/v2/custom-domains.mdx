...
When a custom domain is assigned to a project with an enabled [<ProductName /> for Git Integration](/docs/v2/git-integrations), each push (including merges) to the [Production Branch](/docs/v2/git-integrations#production-branch) (commonly `main`) will trigger a deployment to the defined domain.
