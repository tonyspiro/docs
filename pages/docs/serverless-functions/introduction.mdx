...
export const meta = {
  ...
  editUrl: 'pages/docs/serverless-functions/introduction.mdx',
...
The above example echoes the `body`, path `query`, and `cookies`, passed with the request object, as a JSON object using helper methods provided through the [Request and Response](/docs/v2/serverless-functions/supported-languages/#node.js-request-and-response-objects).
...
<Caption>
  Starting a local development environment using <ProductShortName /> CLI, for
