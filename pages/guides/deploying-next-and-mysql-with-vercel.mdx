...
<Snippet width="100%"dark text="vercel secrets add MYSQL_HOST $database-hostname && vercel secrets add MYSQL_USER $database-username && vercel secrets add MYSQL_DATABASE $database-name && vercel secrets add MYSQL_PASSWORD $database-password" />
<Caption>
...
<Snippet width="100%"dark text="npm i isomorphic-unfetch next react react-dom" />
<Caption>
