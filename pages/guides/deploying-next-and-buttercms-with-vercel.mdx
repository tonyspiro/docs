...
<Snippet width="100%"dark text="mkdir my-nextjs-buttercms-project && cd my-nextjs-buttercms-project" />
...
<Snippet width="100%"dark text="vercel secrets add BUTTER_API_TOKEN your-space-id" />
<Caption>
