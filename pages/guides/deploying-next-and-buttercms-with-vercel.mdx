...
export const meta = {
  ...
  image: `https://og-image.now.sh/**ButterCMS-backed%20Next.js%20apps**%3Cbr%3Ewith%20${PRODUCT_NAME}.png?theme=light&md=1&fontSize=75px&images=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fvercel-triangle-black.svg&images=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2F8%2F8e%2FNextjs-logo.svg&images=https%3A%2F%2Fres.cloudinary.com%2Fpracticaldev%2Fimage%2Ffetch%2Fs--I6CRySrV--%2Fc_limit%252Cf_auto%252Cfl_progressive%252Cq_auto%252Cw_880%2Fhttps%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fdxq0h2d96tpaof9lb9h2.png`,
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-and-buttercms-with-vercel/deploying-next-and-buttercms-with-vercel.png`}
  width={2048 / 2.75}
  height={1170 / 2.75}
  oversize
/>
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-and-buttercms-with-vercel/creating-collection.png`}
  width={1555 / 2}
  height={656 / 2}
  oversize
  shadow
/>
<Caption>
  Creating a Collection for your Next.js + ButterCMS project using the ButterCMS
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-and-buttercms-with-vercel/completed-collection.png`}
  width={1503 / 2}
  height={592 / 2}
  oversize
  shadow
...
<Snippet
  width="100%"
  dark
  text="mkdir my-nextjs-buttercms-project && cd my-nextjs-buttercms-project"
/>
  ...
  useEffect(() => {
    async function getPosts() {
      const res = await fetch(
        `https://api.buttercms.com/v2/content/?keys=posts&auth_token=${process.env.API_TOKEN}`
      )
...
<Snippet
  width="100%"
  dark
  text="vercel secrets add BUTTER_API_TOKEN your-space-id"
/>
<Caption>
  Adding the <InlineCode>BUTTER_API_TOKEN</InlineCode> secret to your project
...
<Snippet width="100%" dark text="next dev" />
<Caption>
