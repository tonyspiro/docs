...
<Snippet width="100%"dark text="echo 'NEXT_DATOCMS_API_TOKEN=YOUR-API-TOKEN' >> .env" />
...
<Snippet width="100%"dark text="echo '.env' >> .gitignore" />
...
<Snippet width="100%"dark text="vercel secrets add datocms_api_token YOUR-API-TOKEN" />
<Caption>
