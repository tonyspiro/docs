...
<Snippet width="100%" dark text="echo 'DATOCMS_API_TOKEN=YOUR-API-TOKEN' >> .env.local" />
<Caption>Creating an environment variable in a <InlineCode>.env.local</InlineCode> file for your API token.</Caption>
