...
<Snippet width="100%"dark text="mkdir -p pusher-channels/api && cd pusher-channels" />
...
<Snippet width="100%"dark text={`vercel secrets add channels-app-id [Your Channel's app ID]`} />
<Caption>
  Adding the <InlineCode>channels-app-id</InlineCode> as a Secret.
</Caption>

<Snippet width="100%"dark text={`vercel secrets add channels-app-secret [Your Channel's app Secret]`} />
<Caption>
