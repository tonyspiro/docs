...
<Snippet width="100%"dark text="vercel secrets add FAUNADB_SECRET_KEY [your-access-key]" />
<Caption>
...
<Snippet width="100%"dark text="mkdir -p faunadb-demo/pages/api && mkdir faunadb-demo/components && cd faunadb-demo" />
<Caption>
