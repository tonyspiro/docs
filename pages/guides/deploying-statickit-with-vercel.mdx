...
<Snippet width="100%"dark text="npm init next-app next-landing-page && cd next-landing-page" />
...
<Snippet width="100%"dark text="npm install -g @statickit/cli && npm install @statickit/react" />
...
<Snippet width="100%"dark text="statickit deploy -k <your-deploy-key>" /><Caption>
