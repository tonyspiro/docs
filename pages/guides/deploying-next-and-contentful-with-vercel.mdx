...
<Snippet width="100%"dark text="mkdir my-nextjs-contentful-project && cd my-nextjs-contentful-project" />
...
<Snippet width="100%"dark text="vercel secrets add contentful_space_id your-space-id" />
<Caption>
...
<Snippet width="100%"dark text="vercel secrets add contentful_access_token your-access-token" />
<Caption>
