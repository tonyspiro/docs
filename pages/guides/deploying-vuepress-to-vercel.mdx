...
<Snippet
  width="100%"
  dark
  text="mkdir vuepress-project && cd vuepress-project"
/>
<Caption>
  Creating and entering into the <InlineCode>vuepress-project</InlineCode>{' '}
  directory.
</Caption>
...
<Snippet width="100%" dark text="npm init -y && npm i -D vuepress" />
<Caption>
