...
<Snippet width="100%"dark text="mkdir svelte-stories && cd svelte-stories && npm init -y" />
...
<Snippet width="100%"dark text="npm i -D @storybook/svelte @babel/core babel-loader" />
